(function ($) {
	...
	/*----------------------------------------*/
	/*  Hemp Shop Sticky Menu Activation
	/*----------------------------------------*/
	...
	/*-------------------------------------------------*/
	/* Hemp Shop Bootstraps 4 Tooltip
	/*-------------------------------------------------*/
	$(function () {
	...
	/*----------------------------------------*/
	/*  Hemp Shop Slick Carousel
 	/*----------------------------------------*/
	var $html = $('html');
	var $body = $('body');
	var $elementCarousel = $('.hemp-shop-slick-slider');
	// Check if element exists
	$.fn.elExists = function () {
		return this.length > 0;
	};
	...
	/*----------------------------------------*/
	/*  Hemp Shop Product Switch Color
 	/*----------------------------------------*/
