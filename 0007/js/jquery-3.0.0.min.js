...
!(function (a, b) {
	...
	var x = (function (a) {
		...
		return (
			...
			(i = ga.select = function (a, b, e, f) {
				...
				return (
					(n || h(a, o))(f, b, !p, e, !b || ($.test(a) && qa(b.parentNode)) || b), e
				);
			}),
	...
	function Wa(a, b, c) {
		...
		if (
			...
			if (
				((d = Ma(a, b, f)), (0 > d || null == d) && (d = a.style[b]), Ka.test(d))
			)
				return d;
	...
	r.fn.extend({
		addClass: function (a) {
			...
			if ("string" == typeof a && a) {
				...
				while ((c = this[i++]))
					if (
						((e = mb(c)), (d = 1 === c.nodeType && (" " + e + " ").replace(lb, " ")))
					) {
						g = 0;
			...
			(l = r.event && o.global),
				...
				o.hasContent
					? o.data &&
					  o.processData &&
					  0 ===
							(o.contentType || "").indexOf("application/x-www-form-urlencoded") &&
				...
				? {
						send: function (e, f) {
							var g,
								h = b.xhr();
							if (
								(h.open(b.type, b.url, b.async, b.username, b.password), b.xhrFields)
							)
